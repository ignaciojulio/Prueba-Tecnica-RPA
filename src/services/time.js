import { makeHttpRequest } from '../lib/http.js';
...
const calculateTimeDifference = (cityUtcOffset, bogotaUtcOffset) => {
  ...
  return (cityOffsetInMinutes - bogotaOffsetInMinutes) / 60;
};
...
export const getTimeData = async (timezone) => {
  ...
  const timeDifference = calculateTimeDifference(data.utc_offset, bogotaTime.utc_offset);
